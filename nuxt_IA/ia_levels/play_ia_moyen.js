...
const TARGET_URL = 'http://localhost:3000/jeu?mode=ia&level=moyen'; // Vous pouvez changer le port si besoin
    ...
    setInterval(async () => {
        ...
        try {
            ...
            const resp = await $fetch(API, { 
                method: 'POST', 
                body: { board: matrix, level: 2, player: 1 } 
            });
            ...
            if (resp.aiMove) {
                ...
                console.log('❌ IA n\'a pas trouvé de mouvement.');
            }
